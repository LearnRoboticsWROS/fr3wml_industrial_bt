#
# FR3WML bringup launch — visual mode (Groot2 monitor + FileLogger2).
#
# bt_runner_node_visual internally builds a MoveGroupInterface, so it MUST
# receive the MoveIt robot_description / semantic / kinematics parameters
# directly — we launch it from here (instead of via the framework's
# bt_runner.launch.py) to inject moveit_config.to_dict() on the node.
#
import os
